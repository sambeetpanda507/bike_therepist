        ...
        <div className={styles.fixdate}>
            <div className={bookStyle.container} className={styles.status}>
                ...
                <div className={styles.infoContainer}>
                    <p className={styles.info}>Below you can find a list of 
                        available time slots for your DUKE 250 service.<br />
                        Click on a time slot to proceed with booking.</p></div>
            </div>
            ...
            <div className={styles.calContainer}>
                ...
                <div className={styles.logo}>
                    <h1><span className={styles.textLogo}>Bike</span><br />
                    <strong>Therapist</strong></h1>
                </div>
            </div>
            <div className={styles.bottom}>
                <div><hr /></div>
                <div><button>&larr; Back</button></div>
            </div>
